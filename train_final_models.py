...
Models: 1X2 (multiclass), Over/Under 2.5 (binary), BTTS (binary).
"""
import pandas as pd
import numpy as np
import pickle
...
def train_final_models():
    ...
    dc_stack = np.column_stack([dc_ou25, dc_btts, dc_home, dc_draw, dc_away])
    ...
    X_ou25 = np.column_stack([X, dc_stack])
    ...
    artifacts = {
        ...
        'historical_df': df,
        'dc_feature_names': ['dc_ou25', 'dc_btts', 'dc_home', 'dc_draw', 'dc_away'],
    }
